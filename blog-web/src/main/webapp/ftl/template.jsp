...
<input type="hidden" id="article_id" value="${articleDO.obj.id }">
    ...
    <div class="am-u-md-8 am-u-sm-12">
      <article class="am-article blog-article-p">
        <div class="am-article-hd">
          <h1 class="am-article-title blog-text-center">${articleDO.obj.pageTitle }</h1>
          <p class="am-article-meta blog-text-center">
              <span><a href="#" class="blog-color">article &nbsp;</a></span>-
              <span><a href="#">@myself &nbsp;</a></span>-
              <span><a href="#">${articleDO.obj.gmtModified}</a></span>
          </p>
        </div>        
        <div class="am-article-bd">
        <#if articleDO.obj.pageImgurl??>
         <img src="${articleDO.obj.pageImgurl}" alt="" class="blog-entry-img blog-article-margin">          
        </#if>
        ...
        <div class="am-g blog-article-widget blog-article-margin">
          <div class="am-u-lg-4 am-u-md-5 am-u-sm-7 am-u-sm-centered blog-text-center">
            <span class="am-icon-tags"> &nbsp;</span><a href="#">标签</a> , <a href="#">${articleDO.obj.pageTag }</a> 
            <hr>
