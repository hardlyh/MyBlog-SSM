	...
	<div id="navbar-menu">
		...
		-->
			<li class="dropdown">
				...
				<span><span class="glyphicon glyphicon-cog"></span></span>
			    <i class="icon-submenu lnr lnr-chevron-down"></i></a>
				<ul class="dropdown-menu">
					<li><a href="/admin/getProfile"><i class="lnr lnr-user"></i> <span>个人信息</span></a></li>
					<li><a href="/admin/admin-update.html"><i class="lnr lnr-cog"></i> <span>修改密码</span></a></li>
					<li><a href="/admin/logout" onclick="return confirm('是否注销');"><i class="lnr lnr-exit"></i> <span>注销</span></a></li>
				</ul>
			</li>
			<!-- 
						升级为pro
