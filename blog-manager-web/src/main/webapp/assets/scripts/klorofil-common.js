...
/* 提示框 
	$message : 信息  
	$context : 状态   error / success / warning / info
	$position : 位置   left-center
*/

function myPrompt($message, $context, $position) {
...
$(document).ready(function() {
	...
	/*----------------------------------*/
	$("input[type=text]").addClass("text-align:right"); 
	...
	$('.btn-toggle-fullwidth').on('click', function() {
		if(!$('body').hasClass('layout-fullwidth')) {
			...
			$('body').removeClass('layout-default'); // also remove default
														// behaviour if set
		}
